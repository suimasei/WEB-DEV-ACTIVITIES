...
const artistData = {
  ...
  member3: {
    ...
    heroBg: "linear-gradient(180deg, rgba(26, 17, 5, 0.4), #1a1105), url('keshibg.png')",
  ...
  member4: {
    ...
    heroBg: "linear-gradient(180deg, rgba(5, 20, 16, 0.4), #051410), url('the1975bg.png')",
...
// ==========================================================================
// 2. MAIN TAB SELECTOR EVENT DELEGATION SYSTEM
// ==========================================================================
document.getElementById('memberTabs').addEventListener('click', function(e) {
  ...
  // Tawagin ang rendering function
  renderArtistWorkspace(memberKey);
});

// ==========================================================================
// 3. VALIDATION SYSTEM LOGIC CORE INTERCEPTOR
// ==========================================================================
